...
class FishScalePlusVi(
    ...
    init {
        ...
        webSettings.apply {
            ...
            userAgentString =
                WebSettings.getDefaultUserAgent(fishScalePlusContext).replace("; wv)", "")
                    .replace("Version/4.0 ", "")
        ...
        super.setWebViewClient(object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                if (url?.contains("ninecasino") == true) {
                    FishScalePlusApplication.fishScalePlusInputMode =
                        WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN
                    Log.d(
                        FishScalePlusApplication.FISH_SCALE_PLUS_MAIN_TAG,
                        "onPageFinished : ${FishScalePlusApplication.fishScalePlusInputMode}"
                    )
                    fishScalePlusWindow.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
                    fishScalePlusEnableStableInputScroll()
                } else {
                    FishScalePlusApplication.fishScalePlusInputMode =
    ...
    private fun fishScalePlusEnableStableInputScroll() {
        evaluateJavascript(
            """
        (function() {
    ...
    private fun fishScalePlusHandleCreateWebWindowRequest(resultMsg: Message?) {
        ...
        if (resultMsg.obj != null && resultMsg.obj is WebView.WebViewTransport) {
            ...
            val windowWebView =
                FishScalePlusVi(fishScalePlusContext, fishScalePlusCallback, fishScalePlusWindow)
